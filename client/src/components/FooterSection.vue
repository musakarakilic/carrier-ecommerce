    ...
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li v-for="category in mockCategories.slice(0, 5)" :key="category.id">
              <RouterLink 
        ...
        <div>
          ...
          <p class="text-gray-300 mb-2">Customer Service: 0850 123 45 67</p>
          <p class="text-gray-300 mb-4">Email: info@ecommerce.com</p>
          
          <h4 class="text-sm font-semibold mb-2">Social Media</h4>
      ...
      <div class="mt-10 pt-8 border-t border-gray-700">
        <h4 class="text-sm font-semibold mb-4">Payment Methods</h4>
        <div class="flex space-x-4">
          <div class="bg-white rounded p-1 h-8 w-12 flex items-center justify-center">
            <span class="text-gray-900 text-xs font-semibold">VISA</span>
          </div>
          <div class="bg-white rounded p-1 h-8 w-12 flex items-center justify-center">
            <span class="text-gray-900 text-xs font-semibold">MC</span>
          </div>
          <div class="bg-white rounded p-1 h-8 w-12 flex items-center justify-center">
            <span class="text-gray-900 text-xs font-semibold">Troy</span>
          </div>
          <div class="bg-white rounded p-1 h-8 w-12 flex items-center justify-center">
            <span class="text-gray-900 text-xs font-semibold">BKM</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="bg-gray-900 py-4">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center">
        ...
        <div class="mt-2 md:mt-0 flex space-x-4">
          ...
          <a href="#" class="text-gray-400 hover:text-gray-300 text-sm">Terms of Use</a>
          <a href="#" class="text-gray-400 hover:text-gray-300 text-sm">GDPR</a>
        </div>
      </div>
    </div>
  </footer>
...
const mockCategories = [
  ...
  { id: 5, name: 'Books & Music' },
  { id: 6, name: 'Hobby & Toys' },
  { id: 7, name: 'Cosmetics & Personal Care' },
  { id: 8, name: 'Jewelry & Accessories' }
];
</script> 